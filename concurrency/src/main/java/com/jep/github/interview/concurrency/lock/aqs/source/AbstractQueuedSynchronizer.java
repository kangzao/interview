package com.jep.github.interview.concurrency.lock.aqs.source;
...
public abstract class AbstractQueuedSynchronizer
    ...
    static final class Node {
        ...
        static final int SIGNAL = -1;//线程已经准备好了，就等资源释放

        static final int CONDITION = -2;// 节点在等待队列中，节点线程等待唤醒

        static final int PROPAGATE = -3;// 当先线程在SHARED情况下，该字段才会使用

        volatile int waitStatus;//初始为0，状态是上面几种
